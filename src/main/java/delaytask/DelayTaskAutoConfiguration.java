 ...
 * @author ALVIN
 */
@ConditionalOnBean(value = {RedisTemplate.class, DelayTaskSubscriber.class})
@Configuration
public class DelayTaskAutoConfiguration {
     ...
     * @return 线程池
     */
    @ConditionalOnMissingBean(name = "delayTaskExecutor")
    ...
    @ConditionalOnMissingBean(DelayTaskChannel.class)
    @Bean
